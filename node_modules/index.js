    ...
    try {
      ...
      session.ev.on("connection.update", async (s) => {
        ...
        if (connection == "open") {
          ...
          let cc = `*Welocme To PasinduLk Whatsapp Bot.*\n\n_Pasindu Lk Bot Made By Pasindu Sehan_.\nPasinduLk Bot owner Number :- wa.me/+94703768140\n*I Am Pasindu Sehan\n*This Bot Owner Channel :- https://www.youtube.com/@psdelzap\n*Thanks For All\nThanks`
